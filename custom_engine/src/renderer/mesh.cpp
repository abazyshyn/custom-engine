...
namespace Engine
{
    ...
    {
        // TODO:
        // ENGINE_TRACE_LOG(LAB_LOG_MESSAGE_SEVERITY_WARNING, "CALLED ", this->GetName());
        // ENGINE_ASSERT(0);
    ...
    void CMesh::Draw(CShader &ct_Shader) const
    {
        ...
        for (size_t i = 0; i < m_Textures.size(); ++i)
        {
            ...
            {
                case ENGINE_TEXTURE_TYPE_DIFFUSE:
                {
                    diffuseNumber += 1;
                    break;
                }

                case ENGINE_TEXTURE_TYPE_SPECULAR:
                {
                    specularNumber += 1;
                    break;
                }
        ...
        // ENGINE_TRACE_LOG("Diffuse textures count: ", diffuseNumber,
