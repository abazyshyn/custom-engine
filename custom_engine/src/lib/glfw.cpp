...
namespace GLFW
{
    ...
    void InitGlfw(GlfwData_s &t_GlfwData)
    {
        ...
        ENGINE_ASSERT(initializationStatus);
        ...
        ENGINE_ASSERT(t_GlfwData.m_pWindow);
        ...
        ENGINE_INFO_LOG("Window created.");
    }

    void ShutdownGlfw(const GlfwData_s &ct_GlfwData)
    {
        ENGINE_INFO_LOG("Window destroyed.");
    ...
    void KeyCallback(GLFWwindow *t_pWindow, int t_Key, int t_Scancode, int t_Action, int t_Mods)
    {
        ...
        {
            ENGINE_INFO_LOG("SHIFT + ESCAPE keys pressed.");
        ...
        {
            ENGINE_INFO_LOG("CONTROL + SHIFT + C keys pressed.");
        ...
        {
            ENGINE_INFO_LOG("CONTROL + SHIFT + X keys pressed.");
        ...
        {
            ENGINE_INFO_LOG("SHIFT + Q keys pressed.");
        ...
        if ((glfwGetKey(t_pWindow, GLFW_KEY_LEFT_CONTROL) ||
            ...
            glfwGetKey(t_pWindow, GLFW_KEY_Q))
        {
            ENGINE_INFO_LOG("CONTROL + Q keys pressed.");
